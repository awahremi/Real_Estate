            ...
            <div className="onboarding-container">
                ...
                <div className="onboarding-host">
                    <div>
                        ...
                        <p>Add the required information, get verified to 
            ...
            <div className="onboarding-container">
                ...
                <div className="onboarding-host">
                    <div>
                        ...
                        <h4>Create an Account</h4>
                        <p>
                            Add the required information to get verified and 
                            set up your account
                        </p>
                    </div>
                    <div>
                        ...
                        <p>
                            Search and compare properties you find interesting
                        </p>
                    </div>
                    <div>
                        ...
                        <p>
                            Contact Owners of properties you want to buy or rent
                        </p>
                    </div>
                </div>
            </div>
